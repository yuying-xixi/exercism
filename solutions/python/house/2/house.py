"""Module to recite verses from the nursery rhyme 'This is the House that Jack Built'."""


def recite(start_verse, end_verse):
    """Recite verses from the cumulative nursery rhyme."""
    ...
    for verse in range(start_verse, end_verse + 1):
        ...
        if verse == 1:
            ...
            for index in range(verse - 1, 0, -1):
                obj, action = parts[index]
                prev_obj = parts[index - 1][0]
